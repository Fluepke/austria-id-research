...
with open("austria-id-key.pem", "wb") as f:
...
with open("austria-id-csr.pem", "wb") as f:
...
with open("austria-id-cert.pem", "wb") as f:
    f.write(cert.public_bytes(serialization.Encoding.PEM))

print("key => austria-id-key.pem")
print("crt => austria-id-cert.pem")
print("Usage example: curl --key austria-id-key.pem --cert austria-id-cert.pem https://backend.awp.oesterreich.gv.at/backend/app/api/v11/users/status")
print("Done")
